...
-  **Σταθμός ESP32 station:** κουμπιά (A/B/C/D/OK), φωτεινές ενδείξεις (RGB  LED) και προαιρετικά μικρή οθόνη (OLED) για απλές επιλογές, κατάσταση ομάδας και γρήγορες ψηφοφορίες/κουιζ.
